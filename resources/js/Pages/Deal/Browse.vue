        ...
        <div class="flex flex-col items-center">
            ...
            <div id="categories-list" class="flex flex-col gap-2 items-start w-full md:w-1/2 p-2">
                <a :href="route('deal.index', { cat: parentCategory != null ? parentCategory.id : 0 })" class="border p-2 text-lg w-full flex justify-between items-center rounded-lg border-yellow-400">
                    ...
                    >
                    <span class="flex flex-row justify-around gap-1 items-center"
                        ><small>(0)</small><fa-icon class="text-yellow-400" icon="fa-solid fa-arrow-right"></fa-icon
                    ></span>
                </a>
                <a :href="route('browse.index', { cat: cat.id })" class="border p-2 text-lg w-full flex justify-between items-center rounded-lg border-yellow-400" v-for="cat in categories">
