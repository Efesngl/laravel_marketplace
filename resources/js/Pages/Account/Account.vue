    ...
    <AccountLayout bg="" title="Account" :backUrl="route('home')">
        <div class="h-[calc(100dvh-3.5rem)] flex p-2">
            <div class="flex flex-col justify-start md:items-center gap-4 w-full">
                ...
                <a :href="route('logout')" class="text-center text-red-500 text-xl p-2 dark:bg-zinc-900 bg-stone-50 hover:opacity-50 transition">Log out <fa-icon icon="fa-solid fa-arrow-right-from-bracket"></fa-icon></a>
            </div>
        </div>
    </AccountLayout>
</template>
